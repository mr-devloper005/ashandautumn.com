...
export const editableRootStyle = {
  '--slot4-page-bg': '#eef5e9',
  '--slot4-page-text': '#101410',
  '--slot4-panel-bg': '#dfeada',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#667160',
  '--slot4-soft-muted-text': '#87917f',
  '--slot4-accent': '#356b1f',
  '--slot4-accent-fill': '#356b1f',
  '--slot4-accent-soft': '#dbead3',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#11170f',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#edf1ea',
  '--slot4-cream': '#fbfcf8',
  '--slot4-warm': '#e6efe2',
  '--slot4-lavender': '#f4f7ef',
  '--slot4-gray': '#edf3e8',
  '--slot4-body-gradient': 'linear-gradient(180deg,#f8fbf4 0%,#eef5e9 48%,#ffffff 100%)',
  '--editable-page-bg': '#eef5e9',
  '--editable-page-text': '#101410',
  '--editable-container': '1180px',
  '--editable-border': '#465447',
  '--editable-nav-bg': '#8fbc7d',
  '--editable-nav-text': '#182217',
  '--editable-nav-active': '#2f651b',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#2f651b',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#b6caaa',
  '--editable-footer-text': '#183014',
} as CSSProperties

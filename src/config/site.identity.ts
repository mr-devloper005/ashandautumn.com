export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'ashandautumn',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Ashandautumn',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'ashandautumn.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://ashandautumn.com',
